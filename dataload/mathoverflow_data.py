...
----------------------------------
train_graph: 
    edata['timestamp']: the timestamp of edge
    ndata['ts_sum']: used for temporal- and frequency- awared contrstive learning
train_neg_graph:
    used for training reconstruct loss
test_graph:
    used for testing
test_neg_graph:
    used for testing
"""
class MathoverflowDataset(DGLDataset):
    def __init__(self, name='my_dataset', slice_interval=60, time_span=60*60*24, verbose=True, tf_decay_rate=0.01,
    ...
    def process(self):
        ...
        # self.slice_interval = 60
        # nodes_data = pd.read_csv('./members.csv')
        edges_data = pd.read_csv('./data/sx-mathoverflow/sx-mathoverflow_reindex.txt', 
        ...
        ## random negative sampling, true negative
        ...
        if self.verb:
            ...
            print("train edges: {}, test edges: {}, train neg edges: {}, test neg edges: {}"\
                .format(self.train_graph.number_of_edges(), self.test_graph.number_of_edges(), neg_eid_nums, test_neg_eid_nums))
