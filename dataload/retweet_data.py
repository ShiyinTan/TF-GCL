...
# graph = dataset[0]
"""
class ReTweetDataset(DGLDataset):
    def __init__(self, name='my_dataset', slice_interval=5, time_span=60*60*24, verbose=True, tf_decay_rate=0.1,
    ...
    def process(self):
        ...
        edges_data = pd.read_csv('./data/ia-retweet-pol/ia-retweet-pol_reindex.edges', 
